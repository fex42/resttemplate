package justme.resttemplate;

import com.fasterxml.jackson.databind.JsonNode;
import justme.resttemplate.client.EmployeeRestClient;
...
class EmployeeRestClientIntegrationTest {
  ...
  @Test
  public void test_getForEntityNotFound() {
    ResponseEntity<Employee> entity = client.getForEntity(-1);
  ...
  void test_delete() {
    ...
    assertFalse(client.getForObject(6).isPresent());
  }
